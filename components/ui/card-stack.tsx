      ...
      {showDots ? (
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          {activeItem.href ? (
            ...
            >
              <span>{activeItem.ctaLabel ?? "Open"}</span>
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        ...
        {active && item.href ? (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-3 inline-flex w-fit items-center gap-1.5 rounded-full bg-white/90 px-3 py-1.5 text-xs font-medium text-black shadow hover:bg-white"
            onClick={(e) => e.stopPropagation()}
